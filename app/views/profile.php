						...
						<div class="table-responsive">
							<table class="table table-striped">
								...
								<tbody>
									...
									$sql = "SELECT o.transaction_code, o.purchase_date, s.name AS status, p.name AS payment_mode FROM orders o JOIN statuses s ON (o.status_id = s.id) JOIN payment_mode p ON (o.payment_mode_id = p.id) WHERE user_id = ". $user['id'];
